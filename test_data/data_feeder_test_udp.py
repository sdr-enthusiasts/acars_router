...
if __name__ == "__main__":
    ...
    if len(received_messages_queue_acars) + len(received_messages_queue_vdlm) == number_of_expected_acars_messages \
        + number_of_expected_vdlm_messages + (duplicated if not check_for_dupes else 0):
