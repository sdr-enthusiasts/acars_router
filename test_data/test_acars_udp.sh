...
socat -dd -x -t5 UDP-LISTEN:25550,fork OPEN:/tmp/acars.udp.out.reference,creat,append &
sleep 1
...
socat -dd -x -t5 UDP-LISTEN:15550,fork OPEN:/tmp/acars.udp.out,creat,append &
sleep 1
