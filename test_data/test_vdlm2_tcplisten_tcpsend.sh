...
socat -d -x -t5 TCP-LISTEN:25555,fork OPEN:/tmp/vdlm2.tcplisten.tcpsend.out.reference,creat,append &
sleep 1
...
socat -d -x -t5 TCP-LISTEN:15555,fork OPEN:/tmp/vdlm2.tcplisten.tcpsend.out,creat,append &
sleep 1
