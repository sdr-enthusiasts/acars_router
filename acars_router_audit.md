...
- PR12 only swapped the macros. Per-task `#[instrument]` spans (`protocol`, `transport`, `peer` fields) replacing the literal `[Message Handler ACARS]`-style prefixes baked into ~50 log strings is deferred to PR12b.
